...
export const BUILTIN_MODULES: AnyManifest[] = [
  congBoNao, ctv, donKhach, gianHang, hangKho, hopThu, khungNenTang, muaHo, thongKe, tienDoiSoat, vanChuyen, xuongNoiDung
];

export { congBoNao, ctv, donKhach, gianHang, hangKho, hopThu, khungNenTang, muaHo, thongKe, tienDoiSoat, vanChuyen, xuongNoiDung };
