  ...
  return {
    ...
    tim(method, pathname) {
      ...
      for (const r of bang) {
        ...
        return { tay: r.tay, moduleId: r.moduleId, tham, path: r.path };
      }
    ...
    banDuong() {
      return bang.map((r) => ({ method: r.method, path: r.path, moduleId: r.moduleId }));
    }
  };
}
