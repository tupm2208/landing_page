...
test("GAY khi hai module khai cung mot duong", () => {
  ...
  const duong = [{ method: "GET", path: "/api/thu", quyen: "cong-khai", hanGoi: { soLan: 100, trongMs: 60000 }, viSaoCongKhai: "Bai kiem tra: duong gia, khong doc du lieu that.", tay: () => ({ ma: 200, than: {} }) }];
  assert.throws(
    () => taoKhung({
...
test("GAY khi module phat su kien no khong khai", () => {
  ...
  const khung = taoKhung({
    ...
    toKhais: [{
      ...
      duong: [{
        method: "GET", path: "/api/phat-bua", quyen: "cong-khai", hanGoi: { soLan: 100, trongMs: 60000 }, viSaoCongKhai: "Bai kiem tra: duong gia, khong doc du lieu that.",
    ...
    toKhais: [
      {
        id: "mot", ten: "Mot", mang: "van-hanh", chay: "server-khach", phienBan: "0.0.1",
        canDichVu: ["hai.docDon"],
        duong: [{ method: "GET", path: "/api/hoi", quyen: "cong-khai", hanGoi: { soLan: 100, trongMs: 60000 }, viSaoCongKhai: "Bai kiem tra: duong gia, khong doc du lieu that.", tay: async (ctx) => ({ ma: 200, than: await ctx.dichVu.hai.docDon("D1") }) }]
      },
      {
...
test("khung tra 404 cho duong la, 405 khi sai phuong thuc", async () => {
  ...
  const khung = taoKhung({
    ...
    toKhais: [{
      id: "mot", ten: "Mot", mang: "van-hanh", chay: "server-khach", phienBan: "0.0.1",
      duong: [{ method: "GET", path: "/api/co", quyen: "cong-khai", hanGoi: { soLan: 100, trongMs: 60000 }, viSaoCongKhai: "Bai kiem tra: duong gia, khong doc du lieu that.", tay: () => ({ ma: 200, than: { ok: true } }) }]
    }]
  });
...
test("module hong khong keo sap khung — tra 500, ghi nhat ky", async () => {
  ...
  const khung = taoKhung({
    ...
    toKhais: [{
      id: "mot", ten: "Mot", mang: "van-hanh", chay: "server-khach", phienBan: "0.0.1",
      duong: [{ method: "GET", path: "/api/no", quyen: "cong-khai", hanGoi: { soLan: 100, trongMs: 60000 }, viSaoCongKhai: "Bai kiem tra: duong gia, khong doc du lieu that.", tay: () => { throw new Error("vo"); } }]
    }]
  });
